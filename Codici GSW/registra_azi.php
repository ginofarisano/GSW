...
// FASE 7: FUNZIONE INVOCATA DAL PULSANTE REGISTRATI, CONTROLLA I CAMPI OBBLIGATORI E SI COLLEGA ALLA PAGINA REGISTRADB_AZI.PHP
...
function invia(){
	...
	if(tmp==1){
		...
		xml.open("get", "registradb_AZI.php?dati="+elementi, true);
		xml.send();
...
<div id="modulo">         
	...
	<!--FASE 6: PULSANTE REGISTRATI CHE CLICCATO INVOCA LA FUNZIONE INVIA()-->
